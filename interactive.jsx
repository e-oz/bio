  ...
  render() {
    return (
        <section>
          ...
          { this.state.open &&
            (<div className="pt1">
              My passion to programming has started in school.<br/>
              ...
              motto).<br/>
              But the most interesting thing about that editor - development of this tool had just 3 computer hours and rest of the code was written using this editor itself (yes, from a mobile phone).<br/>
