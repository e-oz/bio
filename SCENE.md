...
A WebGPU port would require adapting the custom materials and post-processing, followed by fresh visual and performance comparisons. It is not required to run this scene.
